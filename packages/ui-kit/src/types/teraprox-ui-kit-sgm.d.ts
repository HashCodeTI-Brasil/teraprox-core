 ...
 * `teraprox-ui-kit` (meta-package legado) e `@hashcodeti/ui-kit-sgm`.
 *
 ...
 *     re-exportam de `@hashcodeti/ui-kit-sgm`.
 *   - `ui-kit-sgm` depende de `teraprox-ui-kit` (ciclo inverso).
 *   - tsup --dts do `ui-kit` falha ao resolver `@hashcodeti/ui-kit-sgm.d.ts`.
 *
...
declare module '@hashcodeti/ui-kit-sgm' {
