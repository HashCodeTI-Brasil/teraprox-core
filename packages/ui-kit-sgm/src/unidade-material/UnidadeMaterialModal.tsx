// @ts-nocheck — DTS pré-existente: incompat React types entre @hashcodeti/ui-kit-core
// e @hashcodeti/ui-kit-sgm. Bloqueia build do dts. Suprimido até unificação dos
