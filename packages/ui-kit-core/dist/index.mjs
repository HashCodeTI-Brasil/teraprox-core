...
var FrequenciaFormV2 = ({
  ...
  if (value === null) {
    return /* @__PURE__ */ jsxs2("div", { className, children: [
      /* @__PURE__ */ jsx2("div", { className: "text-muted mb-2", children: "Sem recorrencia definida." }),
      /* @__PURE__ */ jsx2(
        Button2,
        {
          size: "sm",
  ...
  return /* @__PURE__ */ jsx2("div", { className, children: /* @__PURE__ */ jsxs2("div", { className: "d-flex flex-wrap gap-2 align-items-end", children: [
    /* @__PURE__ */ jsxs2("div", { style: { flex: "0 0 8rem" }, children: [
      /* @__PURE__ */ jsx2(Form.Label, { children: "A cada" }),
      /* @__PURE__ */ jsx2(
        Form.Control,
        {
          type: "number",
    ...
    /* @__PURE__ */ jsxs2("div", { style: { flex: "1 1 10rem" }, children: [
      /* @__PURE__ */ jsx2(Form.Label, { children: "Escala" }),
      /* @__PURE__ */ jsx2(
        Form.Select,
        {
          disabled,
          ...
          children: visibleEscalas.map((key) => {
            var _a;
            return /* @__PURE__ */ jsx2("option", { value: key, children: (_a = ESCALA_LABELS[key]) != null ? _a : key }, key);
          })
        }
      )
    ] }),
    showDataInicio && /* @__PURE__ */ jsxs2("div", { style: { flex: "1 1 14rem" }, children: [
      /* @__PURE__ */ jsx2(Form.Label, { children: "Data de inicio" }),
      /* @__PURE__ */ jsx2(
        Form.Control,
        {
          type: "datetime-local",
    ...
    onClear && /* @__PURE__ */ jsx2("div", { children: /* @__PURE__ */ jsx2(
      Button2,
      {
        size: "sm",
...
import { Button as Button3, Form as Form2, InputGroup, Table } from "react-bootstrap";
...
var ContadorPicker = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { className, children: [
    /* @__PURE__ */ jsxs3(Form2.Group, { className: "mb-3", controlId: "contador-parametro", children: [
      /* @__PURE__ */ jsx3(Form2.Label, { children: "Par\xE2metro" }),
      /* @__PURE__ */ jsx3(
        Form2.Control,
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxs3(Form2.Group, { className: "mb-3", controlId: "contador-leitura", children: [
      /* @__PURE__ */ jsx3(Form2.Label, { children: "Leitura" }),
    ...
    !hideLimites && /* @__PURE__ */ jsxs3("div", { className: "contador-limites mb-2", children: [
      /* @__PURE__ */ jsxs3("div", { className: "d-flex justify-content-between align-items-center mb-2", children: [
        /* @__PURE__ */ jsx3(Form2.Label, { className: "mb-0", children: "Limites de controle" }),
        /* @__PURE__ */ jsx3(
          Button3,
          {
            variant: "outline-primary",
      ...
      limites.length === 0 ? /* @__PURE__ */ jsx3("div", { className: "text-muted small fst-italic", children: "Nenhum limite configurado." }) : /* @__PURE__ */ jsxs3(Table, { size: "sm", borderless: true, className: "mb-0", children: [
        /* @__PURE__ */ jsx3("thead", { children: /* @__PURE__ */ jsxs3("tr", { children: [
          /* @__PURE__ */ jsx3("th", { style: { width: "40%" }, children: "Nome" }),
          /* @__PURE__ */ jsx3("th", { style: { width: "20%" }, children: "Regra" }),
          /* @__PURE__ */ jsx3("th", { style: { width: "25%" }, children: "Valor" }),
          /* @__PURE__ */ jsx3("th", { style: { width: "15%" } })
        ] }) }),
        /* @__PURE__ */ jsx3("tbody", { children: limites.map((l, idx) => {
          var _a2, _b2;
          return /* @__PURE__ */ jsxs3("tr", { children: [
            ...
            /* @__PURE__ */ jsx3("td", { children: /* @__PURE__ */ jsx3(
              Form2.Select,
              {
                ...
                disabled,
                children: BOUND_RULES.map((r) => /* @__PURE__ */ jsx3("option", { value: r, children: r }, r))
              }
            ) }),
            /* @__PURE__ */ jsx3("td", { children: /* @__PURE__ */ jsx3(
              Form2.Control,
            ...
            /* @__PURE__ */ jsx3("td", { className: "text-end", children: /* @__PURE__ */ jsx3(
              Button3,
              {
                variant: "outline-danger",
                size: "sm",
...
function FileIcon({ category }) {
  switch (category) {
    case "pdf":
      return /* @__PURE__ */ jsx4(FaFilePdf, {});
    case "doc":
      return /* @__PURE__ */ jsx4(FaFileWord, {});
    case "xls":
      return /* @__PURE__ */ jsx4(FaFileExcel, {});
    case "csv":
      return /* @__PURE__ */ jsx4(FaFileCsv, {});
    case "img":
      return /* @__PURE__ */ jsx4(FiImage, {});
    case "vid":
      return /* @__PURE__ */ jsx4(FiFilm, {});
    case "aud":
      return /* @__PURE__ */ jsx4(FiMusic, {});
    case "zip":
      return /* @__PURE__ */ jsx4(FaFileArchive, {});
    default:
      return /* @__PURE__ */ jsx4(FiFile, {});
  }
}
var AnexoManager = ({
  persistidos = [],
  ...
  const [unavailableIds, setUnavailableIds] = useState(/* @__PURE__ */ new Set());
  const [persistImageUrls, setPersistImageUrls] = useState({});
  const [persistImageLoading, setPersistImageLoading] = useState(/* @__PURE__ */ new Set());
  ...
  const handleDownload = useCallback(async (anexo) => {
  ...
  const openLocalImagePreview = useCallback((url, title) => {
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "anexo-manager", children: [
    !readonly && /* @__PURE__ */ jsxs4(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx4("input", { ...getInputProps() }),
          /* @__PURE__ */ jsxs4("div", { className: "anexo-dropzone-inner", children: [
            /* @__PURE__ */ jsx4(FiUploadCloud, { className: "anexo-dropzone-icon" }),
            /* @__PURE__ */ jsx4("p", { className: "anexo-dropzone-text", children: dropzoneLabel || /* @__PURE__ */ jsxs4(Fragment, { children: [
              /* @__PURE__ */ jsx4("strong", { children: "Clique para selecionar" }),
              " ou arraste arquivos aqui"
            ] }) }),
            /* @__PURE__ */ jsxs4("p", { className: "anexo-dropzone-hint", children: [
              "Max. ",
    ...
    (totalCount > 0 || loading) && /* @__PURE__ */ jsxs4("div", { className: "anexo-file-list", children: [
      loading && /* @__PURE__ */ jsx4("div", { className: "anexo-empty", children: "Carregando anexos..." }),
      persistidos.map((anexo) => {
        ...
        return /* @__PURE__ */ jsxs4("div", { className: `anexo-file-item ${isUnavailable ? "anexo-file-unavailable" : ""}`, children: [
          isImg && pImg && !isUnavailable ? /* @__PURE__ */ jsx4(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsx4("img", { src: pImg, alt: "", className: "anexo-file-thumb anexo-file-thumb--lg" })
            }
          ) : isImg && pLoading ? /* @__PURE__ */ jsx4("div", { className: "anexo-persist-thumb-skel", "aria-hidden": true }) : /* @__PURE__ */ jsx4("div", { className: `anexo-file-icon anexo-icon-${cat}`, children: /* @__PURE__ */ jsx4(FileIcon, { category: cat }) }),
          /* @__PURE__ */ jsxs4("div", { className: "anexo-file-info", children: [
            canPreviewImage ? /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
            ...
            ) : /* @__PURE__ */ jsx4("div", { className: "anexo-file-name", title: displayName, children: displayName }),
            /* @__PURE__ */ jsxs4("div", { className: "anexo-file-meta", children: [
              isUnavailable && /* @__PURE__ */ jsx4("span", { className: "anexo-status-error", children: "Anexo indisponivel" }),
              !isUnavailable && anexo.tamanho ? /* @__PURE__ */ jsx4("span", { children: formatFileSize(anexo.tamanho) }) : null,
              anexo.createdAt && /* @__PURE__ */ jsx4("span", { children: new Date(anexo.createdAt).toLocaleDateString("pt-BR") })
            ] })
          ] }),
          /* @__PURE__ */ jsxs4("div", { className: "anexo-file-actions", children: [
            onDownload && !isUnavailable && /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsx4(FiDownload, {})
              }
            ),
            !readonly && onRemovePersistido && /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsx4(FiTrash2, {})
              }
            )
          ] })
        ] }, `p-${anexo.id}`);
      ...
      locais.map((anexo) => {
        ...
        return /* @__PURE__ */ jsxs4("div", { className: "anexo-file-item", children: [
          isImg && localPreviewUrl ? /* @__PURE__ */ jsx4(
            "button",
            {
              type: "button",
              className: "anexo-persist-thumb-wrap",
              ...
              children: /* @__PURE__ */ jsx4("img", { src: localPreviewUrl, alt: "", className: "anexo-file-thumb anexo-file-thumb--lg" })
            }
          ) : /* @__PURE__ */ jsx4("div", { className: `anexo-file-icon anexo-icon-${cat}`, children: /* @__PURE__ */ jsx4(FileIcon, { category: cat }) }),
          /* @__PURE__ */ jsxs4("div", { className: "anexo-file-info", children: [
            isImg && localPreviewUrl ? /* @__PURE__ */ jsx4(
              "button",
              {
            ...
            ) : /* @__PURE__ */ jsx4("div", { className: "anexo-file-name", title: localNome, children: localNome }),
            /* @__PURE__ */ jsxs4("div", { className: "anexo-file-meta", children: [
              /* @__PURE__ */ jsx4("span", { children: formatFileSize(anexo.tamanho) }),
              anexo.status === "uploading" && /* @__PURE__ */ jsx4("span", { className: "anexo-status-uploading", children: "Enviando..." }),
              anexo.status === "error" && /* @__PURE__ */ jsx4("span", { className: "anexo-status-error", children: anexo.errorMessage || "Erro" })
            ] }),
            (anexo.status === "uploading" || anexo.status === "done") && /* @__PURE__ */ jsx4("div", { className: "anexo-progress-bar", children: /* @__PURE__ */ jsx4(
              "div",
              {
            ...
            anexo.status === "error" && /* @__PURE__ */ jsx4("div", { className: "anexo-progress-bar", children: /* @__PURE__ */ jsx4("div", { className: "anexo-progress-fill anexo-progress-error", style: { width: "100%" } }) })
          ] }),
          /* @__PURE__ */ jsxs4("div", { className: "anexo-file-actions", children: [
            anexo.status === "error" && onRetry && /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
                ...
                children: /* @__PURE__ */ jsx4(FiRefreshCw, {})
              }
            ),
            (anexo.status === "pending" || anexo.status === "error") && onRemoveLocal && /* @__PURE__ */ jsx4(
              "button",
              {
                type: "button",
                className: "anexo-btn-action anexo-btn-danger",
    ...
    !loading && totalCount === 0 && readonly && /* @__PURE__ */ jsx4("div", { className: "anexo-empty", children: "Nenhum anexo encontrado." }),
    lightbox && /* @__PURE__ */ jsx4(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs4("div", { className: "anexo-lightbox-panel", onClick: (e) => e.stopPropagation(), children: [
          /* @__PURE__ */ jsx4(
            "button",
            {
              type: "button",
              ...
              "aria-label": "Fechar",
              children: /* @__PURE__ */ jsx4(FiX, {})
            }
          ),
          /* @__PURE__ */ jsx4("div", { className: "anexo-lightbox-title", children: lightbox.title }),
          /* @__PURE__ */ jsx4("div", { className: "anexo-lightbox-img-wrap", children: /* @__PURE__ */ jsx4("img", { src: lightbox.url, alt: lightbox.title, className: "anexo-lightbox-img" }) })
        ] })
      }
    )
  ] });
...
import { Form as Form3 } from "react-bootstrap";
...
var ClickToWriteField = ({
  ...
  return /* @__PURE__ */ jsxs5(Form3.Group, { className: "mb-2", children: [
    label && /* @__PURE__ */ jsx5(Form3.Label, { className: "small text-muted", children: label }),
    /* @__PURE__ */ jsx5(
      Form3.Control,
      {
        size: "sm",
  ...
  if (variant === "intersection") {
    return /* @__PURE__ */ jsxs6(
      "svg",
      {
        ...
        "aria-hidden": "true",
        children: [
          /* @__PURE__ */ jsx6("defs", { children: /* @__PURE__ */ jsx6("clipPath", { id: "clipA-intersection", children: /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6" }) }) }),
          /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6", fill: OFF, stroke: STROKE, strokeWidth }),
          /* @__PURE__ */ jsx6("circle", { cx: "15", cy: "12", r: "6", fill: OFF, stroke: STROKE, strokeWidth }),
          /* @__PURE__ */ jsx6(
            "circle",
            {
              cx: "15",
  ...
  if (variant === "xor") {
    return /* @__PURE__ */ jsxs6(
      "svg",
      {
        ...
        "aria-hidden": "true",
        children: [
          /* @__PURE__ */ jsx6("defs", { children: /* @__PURE__ */ jsxs6("mask", { id: "mask-xor", children: [
            /* @__PURE__ */ jsx6("rect", { width: "24", height: "24", fill: "black" }),
            /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6", fill: "white" }),
            /* @__PURE__ */ jsx6("circle", { cx: "15", cy: "12", r: "6", fill: "white" }),
            /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6", fill: "black", mask: "url(#inner-xor)" }),
            /* @__PURE__ */ jsxs6("g", { children: [
              /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6", fill: "white" }),
              /* @__PURE__ */ jsx6("circle", { cx: "15", cy: "12", r: "6", fill: "white" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6", fill: FILL, opacity: 0.85 }),
          /* @__PURE__ */ jsx6("circle", { cx: "15", cy: "12", r: "6", fill: FILL, opacity: 0.85 }),
          /* @__PURE__ */ jsxs6("g", { children: [
            /* @__PURE__ */ jsx6("defs", { children: /* @__PURE__ */ jsx6("clipPath", { id: "clipA-xor", children: /* @__PURE__ */ jsx6("circle", { cx: "9", cy: "12", r: "6" }) }) }),
            /* @__PURE__ */ jsx6(
              "circle",
              {
                cx: "15",
      ...
      children: MODES.map((m) => {
        ...
        return /* @__PURE__ */ jsxs6(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx6(VennIcon, { variant: m, size }),
              showLabel ? /* @__PURE__ */ jsx6("span", { style: { fontSize: "0.75rem" }, children: cfg.short }) : null
            ]
          },
          m
        );
