...
// O FrequenciaFormV2 virou cross-domain e passou a viver em @hashcodeti/ui-kit-core.
...
// caller direto para @hashcodeti/ui-kit-core quando possivel.
export {
  FrequenciaFormV2,
...
export { FrequenciaFormV2 as default } from '@hashcodeti/ui-kit-core'
