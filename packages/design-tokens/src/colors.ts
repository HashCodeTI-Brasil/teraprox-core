// @hashcodeti/design-tokens — Colors
//
// Fonte única de verdade para a paleta visual do ecossistema Teraprox.
// Extraído da auditoria 2026-05-02 (wiki/arquitetura/ui-kit-core-brand-audit.md).
//
// Histórico:
//   - 2026-05-02: criado dentro de ui-kit-core/src/tokens/colors.ts
//   - 2026-05-11: movido para pacote dedicado @hashcodeti/design-tokens (Fase 1)
//
