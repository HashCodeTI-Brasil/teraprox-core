...
var RolePill = ({ role, size = "sm" }) => {
  ...
  if (!isKnown) {
    return /* @__PURE__ */ jsx3("span", { className: `inline-flex items-center rounded-md ring-1 ring-inset ring-neutral-200 bg-neutral-100 text-neutral-700 font-medium ${SIZE3[size]}`, children: raw });
  }
  ...
  return /* @__PURE__ */ jsxs2(
    "li",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx4("div", { className: "hidden sm:block min-w-[110px]", onClick: stop, children: canEditRole && onChangeRole ? /* @__PURE__ */ jsx4(
          RoleEditor,
          {
            currentRole: role,
            disabled: savingRole,
        ...
        /* @__PURE__ */ jsx4("div", { className: "flex gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity", onClick: stop, children: onDelete && /* @__PURE__ */ jsx4(
          "button",
          {
            type: "button",
            onClick: (e) => {
...
var RoleEditor = ({ currentRole, disabled, onChange }) => {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "relative inline-block", children: [
    /* @__PURE__ */ jsx4(RolePill, { role: currentRole }),
    /* @__PURE__ */ jsxs2(
      "select",
      {
        ...
        children: [
          !valueInEnum && /* @__PURE__ */ jsx4("option", { value: "", disabled: true, children: currentRole != null ? currentRole : "\u2014" }),
          ROLE_VALUES.map((r) => /* @__PURE__ */ jsx4("option", { value: r, children: r }, r))
        ]
      }
    )
  ] });
