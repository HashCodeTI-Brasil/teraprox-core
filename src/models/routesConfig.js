...
export const routesConfig = [
    ...
    },
    {
        ...
        routes: [
            ...
            { configuration: { context: "ordemDeCorrecao", path: paths.ordemDeCorrecaoForm, endPoint: endPointCaderno } },
            { configuration: { context: "ordemDeCorrecao", path: paths.ordemDeCorrecaoApontar, endPoint: endPointCaderno } },
            { configuration: { context: "autorizacaoDeCorrecao", path: paths.ordensDeCorrecao, endPoint: endPointCaderno } },
            { configuration: { context: "autorizacaoDeCorrecao", path: paths.ordemDeCorrecaoForm, endPoint: endPointCaderno } },
            ...
            { configuration: { context: "limiteDeControle", path: paths.planoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "limiteDeControle", path: paths.linhaDePlanoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "especificacao", path: paths.planosDeControle, endPoint: endPointCaderno } },
            { configuration: { context: "especificacao", path: paths.planoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "especificacao", path: paths.linhaDePlanoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "controle", path: paths.planosDeControle, endPoint: endPointCaderno } },
            { configuration: { context: "controle", path: paths.planoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "controle", path: paths.linhaDePlanoDeControleForm, endPoint: endPointCaderno } },
            { configuration: { context: "frequencia", path: paths.frequenciaForm, endPoint: endPointCaderno } },
            { configuration: { context: "frequencia", path: paths.linhaDePlanoDeControleForm, endPoint: endPointCaderno } },
    ...
    },
    {
        ...
        routes: [
            ...
            { configuration: { context: "anexo", path: "/ordemDeServico/anexo", endPoint: endPointManutencao } },
